...
SELECT
    ...
    po.approved as "Estado da ordem",
    po.workflow_status as "Estado do processo",
    po.manual_po as "Ordem Manual",
    po.order_type as "Tipologia",
    po.date_ordered as "Data da ordem",
    po.approval_date as "Data de Aprovação",
    pol.po_line_number as "Nr Linha",
    pol.receipt_status as "Estado de entrega",
    pol.payment_status as "Estado do pagamento",
    pol.receipt_date as "Data Recepção",
